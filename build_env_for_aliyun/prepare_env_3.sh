...
for filename in replicated-ring-party.x replicated-field-party.x ps-rep-ring-party.x ps-rep-field-party.x semi2k-party.x semi-party.x spdz2k-party.x mascot-party.x semi-offline.x semi2k-offline.x
do
...
sed -i "s/\"kernel_space_heap_size\": \"32MB\",/\"kernel_space_heap_size\": \"256MB\",/g" Occlum.json
sed -i "s/\"kernel_space_stack_size\": \"1MB\",/\"kernel_space_stack_size\": \"16MB\",/g" Occlum.json
sed -i "s/\"user_space_size\": \"300MB\",/\"user_space_size\": \"16GB\",/g" Occlum.json
sed -i "s/\"max_num_of_threads\": 32/\"max_num_of_threads\": 128/g" Occlum.json
sed -i "s/\"default_stack_size\": \"4MB\",/\"default_stack_size\": \"64MB\",/g" Occlum.json
sed -i "s/\"default_heap_size\": \"32MB\",/\"default_heap_size\": \"2GB\",/g" Occlum.json
sed -i "s/\"default_mmap_size\": \"100MB\"/\"default_mmap_size\": \"8GB\"/g" Occlum.json
