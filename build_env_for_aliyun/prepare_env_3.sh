...
mkdir -p image/MP-SPDZ/local/lib
cp ../libFHE.so image/MP-SPDZ/ 
cp ../libSPDZ.so image/MP-SPDZ/
cp ../local/lib/libboost_filesystem.so.1.83.0 image/MP-SPDZ/local/lib/
cp ../local/lib/libboost_iostreams.so.1.83.0 image/MP-SPDZ/local/lib/
