...
logFolder=/root/llm-project/NFGen+KAN/Results/${protocol}/${network}/approx_logs/
clogFolder=/root/llm-project/NFGen+KAN/Results/${protocol}/${network}/approx_logs/Compile/
clogFile=${clogFolder}approx_compile_log-${N}
logFile=${logFolder}approx_execution_log-${N}
sourceFile=multivariate_approx_performance
