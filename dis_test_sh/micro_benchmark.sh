...
func_array=(sigmoid tanh soft_plus elu selu gelu soft_sign isru snormal_dis scauchy_dis gamma_dis sexp_dis chi_square slog_dis bs_dis);

func_array1=(sigmoid tanh soft_plus elu selu gelu soft_sign)
func_array2=(isru snormal_dis scauchy_dis gamma_dis sexp_dis chi_square slog_dis bs_dis)
